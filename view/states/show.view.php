    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="/?controller=state&action=destroy&id=<?= $state->id ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
            </div>
        </div>
    </div>
</div>
...
<a href="/?controller=state&action=edit&id=<?= $state->id ?>"><button type="button" class="btn btn-primary">Modifier</button></a>
